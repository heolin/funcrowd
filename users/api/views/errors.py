...
class PasswordTokenWrong(APIException):
    status_code = status.HTTP_400_BAD_REQUEST
    default_detail = 'Password token is incorrect'
    default_code = 'password_token_wrong'


class PasswordTokenExpired(APIException):
    status_code = status.HTTP_400_BAD_REQUEST
    default_detail = 'Password token has expired'
    default_code = 'password_token_expired'


class PasswordTokenUsed(APIException):
    status_code = status.HTTP_400_BAD_REQUEST
